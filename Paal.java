...
//	Kaart kaart = new Kaart();
	...
	public void choise() {
		...
		choiseInput = sc.nextInt();	// User input might also need to be changed.
	}
	
	public void inchecken(Kaart kaart) {
//		Other two use cases haven't been made yet. Replace/remove this later!
		if (choiseInput == 2 || choiseInput == 3) {
