...
public class Driver {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("Wilt u Inchecken | Uitchecken | Saldo-bekijken | Stoppen");	// Keuze tussen de verschillende dingen die je kunt doen
			
			choiseInput = sc.next();
			
			if (kaart.getGeldigePas() == false) {
				System.out.println("Validatie error. Probeer het opnieuw of check uw pas.");
			} else if (choiseInput.equalsIgnoreCase("inchecken")) {
			...
			} else if (choiseInput.equalsIgnoreCase("uitchecken")) {
